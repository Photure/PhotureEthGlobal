...
class AvatarHeader extends React.Component {
      ...
      <View style={[styles.headerWrapper, styles.userModalHeader, { backgroundColor }]}>
        <View style={styles.headerMenu}>
          ...
          <View style={styles.headerTitleContainer}>
            <Animated.View style={[styles.headerPic, { opacity: imageOpacity }]}>
              <SvgUri
                width="30"
                height="30"
  ...
  renderAvatarForeground = () => {
    const { walletAddress, subtitle, title } = this.props;
    ...
    return (
      <View style={styles.foreground}>
        <Animated.View style={{ opacity: imageOpacity }}>
          <Animated.View style={[styles.profilePic, { width: imageSize, height: imageSize }]}>
            <SvgUri
              width="90"
              height="90"
              uri={`https://avatars.dicebear.com/api/pixel-art/${walletAddress}.svg`}
